...
class Agent:
    def __init__(self, name, embeddings_dir, device_type, use_history, model_type, persist_dir, promptTemplate_type, opening_statement):
        self.name = name  
    ...
    def ask(self, query):
        complete_query = self.opening_statement + query
